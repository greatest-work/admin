...
declare const Transfer: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "data" | "title" | "modelValue" | "defaultValue" | "simple" | "selected" | "showSearch" | "defaultSelected" | "oneWay">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "select", selected: string[]) => void) & ((event: "update:modelValue", value: string[]) => void) & ((event: "change", value: string[]) => void) & ((event: "search", value: string, type: "source" | "target") => void) & ((event: "update:selected", selected: string[]) => void);
        $el: any;
