...
declare const Table: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            onChange?: ((data: import("./interface").TableData[], extra: import("./interface").TableChangeExtra) => any) | undefined;
            onSelect?: ((rowKeys: string[], rowKey: string, record: import("./interface").TableData) => any) | undefined;
            onPageChange?: ((page: number) => any) | undefined;
            onPageSizeChange?: ((pageSize: number) => any) | undefined;
            onExpand?: ((rowKey: string, record: import("./interface").TableData) => any) | undefined;
            "onUpdate:selectedKeys"?: ((rowKeys: string[]) => any) | undefined;
            "onUpdate:expandedKeys"?: ((rowKeys: string[]) => any) | undefined;
            onExpandedChange?: ((rowKeys: string[]) => any) | undefined;
            onSelectAll?: ((checked: boolean) => any) | undefined;
            onSelectionChange?: ((rowKeys: string[]) => any) | undefined;
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "data" | "loading" | "bordered" | "columns" | "hoverable" | "pagination" | "stripe" | "tableLayoutFixed" | "pagePosition" | "indentSize" | "rowKey" | "showHeader" | "spanAll" | "filterIconAlignLeft" | "hideExpandButtonOnEmpty" | "columnResizable" | "summaryText" | "defaultExpandAllRows" | "stickyHeader">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "select", rowKeys: string[], rowKey: string, record: import("./interface").TableData) => void) & ((event: "change", data: import("./interface").TableData[], extra: import("./interface").TableChangeExtra) => void) & ((event: "pageChange", page: number) => void) & ((event: "pageSizeChange", pageSize: number) => void) & ((event: "expand", rowKey: string, record: import("./interface").TableData) => void) & ((event: "update:selectedKeys", rowKeys: string[]) => void) & ((event: "update:expandedKeys", rowKeys: string[]) => void) & ((event: "expandedChange", rowKeys: string[]) => void) & ((event: "selectAll", checked: boolean) => void) & ((event: "selectionChange", rowKeys: string[]) => void) & ((event: "sorterChange", dataIndex: string, direction: string) => void) & ((event: "filterChange", dataIndex: string, filteredValues: string[]) => void) & ((event: "cellClick", record: import("./interface").TableData, column: import("./interface").TableColumnData, ev: Event) => void) & ((event: "rowClick", record: import("./interface").TableData, ev: Event) => void) & ((event: "headerClick", column: import("./interface").TableColumnData, ev: Event) => void) & ((event: "columnResize", dataIndex: string, width: number) => void);
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<{
            ...
            render: () => JSX.Element;
            selfExpand: (rowKey: string | string[], expanded?: boolean) => void;
            selfExpandAll: (expanded?: boolean) => void;
            selfSelect: (rowKey: string | string[], checked?: boolean) => void;
            ...
            select(rowKey: string | string[], checked?: boolean | undefined): void;
            expandAll(checked?: boolean | undefined): void;
            expand(rowKey: string | string[], checked?: boolean | undefined): void;
            ...
            expand: (rowKey: string, record: import("./interface").TableData) => true;
            expandedChange: (rowKeys: string[]) => true;
            select: (rowKeys: string[], rowKey: string, record: import("./interface").TableData) => true;
            ...
            change: (data: import("./interface").TableData[], extra: import("./interface").TableChangeExtra) => true;
