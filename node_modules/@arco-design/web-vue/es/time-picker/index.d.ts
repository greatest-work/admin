...
declare const TimePicker: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "popupVisible" | "defaultPopupVisible" | "position" | "disabled" | "unmountOnClose" | "size" | "type" | "error" | "readonly" | "allowClear" | "format" | "disableConfirm" | "use12Hours" | "hideDisabledOptions">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
