...
declare const Input: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "type" | "error" | "defaultValue" | "readonly" | "allowClear" | "maxLength" | "showWordLimit">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
