...
declare const AutoComplete: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "strict" | "data" | "modelValue" | "defaultValue" | "allowClear" | "filterOption">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "clear", ev: Event) => void) & ((event: "select", value: string) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "change", value: string) => void) & ((event: "search", value: string) => void);
        $el: any;
