...
declare const Dropdown: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "popupVisible" | "defaultPopupVisible" | "trigger" | "position" | "popupMaxHeight">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
