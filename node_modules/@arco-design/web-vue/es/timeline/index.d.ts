...
declare const Timeline: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            labelPosition: import("./interface").LabelPositionType;
            pending: boolean;
        } & {}> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "mode" | "reverse" | "direction" | "labelPosition" | "pending">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
    ...
    Item: import("vue").DefineComponent<{
        ...
        cls: import("vue").ComputedRef<(string | {
            [x: string]: boolean | "horizontal" | "vertical" | import("./interface").LabelPositionType;
        })[]>;
