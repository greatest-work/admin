...
declare const List: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "loading" | "bordered" | "maxHeight" | "split" | "hoverable" | "bottomOffset">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "scroll") => void) & ((event: "pageChange", page: number) => void) & ((event: "pageSizeChange", pageSize: number) => void) & ((event: "reachBottom") => void);
        $el: any;
