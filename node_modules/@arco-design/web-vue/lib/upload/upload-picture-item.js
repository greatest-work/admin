...
var UploadPictureItem = vue.defineComponent({
  ...
  setup(props) {
    ...
    const renderCard = () => {
      ...
      }, [props.file.status !== "error" && vue.createVNode("span", {
      ...
      }, [(_A = (_z = (_w = uploadCtx == null ? void 0 : (_v = uploadCtx.slots)["remove-icon"]) == null ? void 0 : _w.call(_v)) != null ? _z : (_y = (_x = uploadCtx == null ? void 0 : uploadCtx.customIcon) == null ? void 0 : _x.removeIcon) == null ? void 0 : _y.call(_x)) != null ? _A : vue.createVNode(index$3, null, null)])])])]);
    };
