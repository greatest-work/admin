...
function getKey(value) {
  return is.isObject(value) ? value.value : value;
}
function getLabel(value) {
  return is.isObject(value) ? value.label : void 0;
}
  ...
  function getLabelValues(value, originValue) {
    ...
    if (validValue.length) {
      ...
      validValue.forEach((item) => {
        ...
        res.push(__spreadProps(__spreadValues(__spreadValues({}, is.isObject(item) ? item : {}), originValueItem || {}), {
          value: key,
