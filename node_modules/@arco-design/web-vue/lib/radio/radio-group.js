...
var RadioGroup = vue.defineComponent({
  ...
  setup(props, {
    ...
    const renderOptions = () => {
      return options.value.map((option) => vue.createVNode(radio, {
        "key": option.value,
        "value": option.value,
