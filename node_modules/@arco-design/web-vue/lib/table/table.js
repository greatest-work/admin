...
var index$4 = require("../icon/icon-plus/index.js");
...
var _Table = vue.defineComponent({
  ...
  setup(props, {
    ...
    vue.watch(virtualListRef, (instance) => {
    ...
    const renderEmpty = () => {
      return vue.createVNode(tableTr, {
        ...
        default: () => [vue.createVNode(tableTd, {
          ...
          default: () => {
            var _a, _b;
            return [(_b = (_a = slots.empty) == null ? void 0 : _a.call(slots)) != null ? _b : vue.createVNode(index$2, null, null)];
          }
        })]
      });
    };
    ...
    const renderVirtualListBody = () => {
      return vue.createVNode(clientOnly, null, {
        default: () => [vue.createVNode(virtualList, vue.mergeProps({
          "ref": virtualListRef,
    ...
    const renderExpandBtn = (record, stopPropagation = true) => {
      ...
      return vue.createVNode("button", {
        ...
        expanded,
        record: record.raw
      })) != null ? _d : (_c = (_b = props.expandable) == null ? void 0 : _b.icon) == null ? void 0 : _c.call(_b, expanded, record.raw)) != null ? _e : expanded ? vue.createVNode(index$3, null, null) : vue.createVNode(index$4, null, null)]);
    };
    ...
    const renderContent = () => {
      if (splitTable.value) {
        ...
        return vue.createVNode(vue.Fragment, null, [props.showHeader && vue.createVNode("div", {
          "ref": theadRef,
        ...
        }, null), renderHeader()])]), isVirtualList.value ? renderVirtualListBody() : vue.createVNode(resizeObserver, {
          "onResize": handleTbodyResize
        }, {
          default: () => {
            var _a, _b;
    ...
    const renderTable = (content) => {
      ...
      return vue.createVNode(vue.Fragment, null, [vue.createVNode("div", {
        ...
        "style": style2,
        "onScroll": handleScroll
      }, [content ? vue.createVNode("table", {
        "class": `${prefixCls}-element`,
        "cellpadding": 0,
        "cellspacing": 0
      }, [content()]) : renderContent()])]), slots.footer && vue.createVNode("div", {
