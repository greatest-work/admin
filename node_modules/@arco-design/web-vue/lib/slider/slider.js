...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("div", {
      ...
      }, null, 8, ["style", "value", "direction", "disabled", "min", "max", "format-tooltip", "onMovestart", "onMoving", "onMoveend"])) : vue.createCommentVNode("v-if", true),
      vue.createVNode(_component_slider_button, {
        ...
        onMoveend: _ctx.handleMoveEnd
      }, null, 8, ["style", "value", "direction", "disabled", "min", "max", "format-tooltip", "onMovestart", "onMoving", "onMoveend"])
    ], 2),
