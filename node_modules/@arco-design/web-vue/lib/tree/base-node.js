...
const _sfc_main = vue.defineComponent({
  ...
  setup(props) {
    ...
    return {
      ...
      treeDragIcon,
      treeNodeIcon,
      extra: vue.computed(() => treeContext.nodeExtra ? () => {
        var _a;
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("span", {
      ...
      _ctx.$slots.icon || _ctx.icon || _ctx.treeNodeIcon ? (vue.openBlock(), vue.createElementBlock("span", {
        ...
        _ctx.$slots.icon ? vue.renderSlot(_ctx.$slots, "icon", { key: 0 }) : _ctx.icon ? (vue.openBlock(), vue.createBlock(_component_RenderFunction, {
          key: 1,
          "render-func": _ctx.icon
        }, null, 8, ["render-func"])) : _ctx.treeNodeIcon ? (vue.openBlock(), vue.createBlock(_component_RenderFunction, {
          key: 2,
          "render-func": _ctx.treeNodeIcon,
          node: _ctx.treeNodeData
        }, null, 8, ["render-func", "node"])) : vue.createCommentVNode("v-if", true)
      ...
      vue.createElementVNode("span", {
        ...
        _ctx.draggable ? (vue.openBlock(), vue.createElementBlock("span", {
          ...
          _ctx.$slots["drag-icon"] ? vue.renderSlot(_ctx.$slots, "drag-icon", { key: 0 }) : _ctx.dragIcon ? (vue.openBlock(), vue.createBlock(_component_RenderFunction, {
            key: 1,
            "render-func": _ctx.dragIcon
          }, null, 8, ["render-func"])) : _ctx.treeDragIcon ? (vue.openBlock(), vue.createBlock(_component_RenderFunction, {
            key: 2,
            "render-func": _ctx.treeDragIcon,
            node: _ctx.treeNodeData
          }, null, 8, ["render-func", "node"])) : (vue.openBlock(), vue.createBlock(_component_IconDragDotVertical, { key: 3 }))
        ], 2)) : vue.createCommentVNode("v-if", true)
      ], 2)
    ], 42, _hoisted_1),
