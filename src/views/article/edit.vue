<template>
    ...
    >
      ...
      <a-form-item field="tags" label="文章标签">
        <a-input-tag :default-value="[]" v-model="data.form.tags" placeholder="请输入文章标签" allow-clear/>
      </a-form-item>
      ...
      <a-form-item>
        <a-button html-type="submit" type="primary" long>{{confirmText}}</a-button>
      </a-form-item>
    </a-form>
    </a-page-header>
...
export default {
  name: "article-edit",
  setup() {
    const { getSiteList, getUserList, addArticle, getArticleInfo, updateArticles } = inject("api");
